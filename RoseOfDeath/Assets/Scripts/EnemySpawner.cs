...
public class EnemySpawner : MonoBehaviour
{
    ...
    public GameObject thirdEnemyPrefab; // Prefab of the third type of enemy
    ...
    public float thirdEnemyDistance = 15f; // Distance at which the third type of enemy spawns
        ...
        if (!isDestroyed)
        {
            ...
            switch (enemyType)
            {
                case 0:
                    ...
                    break;
                case 1:
                    enemyToSpawn = secondEnemyPrefab;
                    spawnDistance = secondEnemyDistance;
                    break;
                case 2:
                    enemyToSpawn = thirdEnemyPrefab;
                    spawnDistance = thirdEnemyDistance;
                    break;
            }

            // Spawn the chosen type of enemy
            SpawnEnemy(enemyToSpawn, spawnDistance);
        }
    }
